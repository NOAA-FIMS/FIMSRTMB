...
Beverton-Holt recruitment function in `rcpp_recruitment.hpp` to make it callable from RTMB.
...
`evaluate_mean` function, this is where the Beverton-Holt C++ function is called. 
...
- For parameters that are set within the function, set them to equal the value of each pointer,
  e.g. `= *logit_steep_ptr`
